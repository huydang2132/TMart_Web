        ...
        <div class="cart-section">
                ...
                <div class="cart-body">
                    <div class="cart-content" v-for="item in 10" :key="item">
                        <div class="cart-content-name cart-name">
                            ...
                            <span title="">Quần tây nam hàn quốc JBagy dáng baggy vải co giãn dày dặn dáng suông ống rộng,
                                màu
                                đen,
                                kem -
                                JA0101</span>
                        ...
                        <div class="cart-content-quantity cart-quantity">
                            <div class="select-quantity">
                                ...
                                <b-input @input="validInputQuantity" @keydown="handleArrowUpDown($event)"
                                    v-model="quantity" />
            ...
            <div class="cart-sell">
                ...
                <div class="cart-sell-voucher">
                    <h5>Mã khuyến mãi</h5>
                    <b-button icon="fa-solid fa-ticket" value="Chọn hoặc nhập mã khuyến mãi" color="var(--color-primary)" />
                </div>
